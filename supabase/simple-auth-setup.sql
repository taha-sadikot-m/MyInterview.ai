-- Simple Authentication Setup for Supabase
-- This script creates the essential authentication components
...
-- Drop profiles table if it exists (clean slate)
...
SELECT 
    ...
    'Profiles table, triggers, and policies created successfully' as message;